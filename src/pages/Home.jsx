        ...
        <div className="relative max-w-7xl mx-auto px-10 flex items-center justify-between flex-wrap gap-10">
          ...
          <div className="max-w-xl">
            ...
            <div className="flex gap-8">
              <div>
                <div className="text-2xl font-bold text-gray-800 dark:text-gray-100">2M+</div>
                <div className="text-sm text-gray-500 dark:text-gray-400">{t('hero_stat_users')}</div>
              </div>
              <div>
                <div className="text-2xl font-bold text-gray-800 dark:text-gray-100">500+</div>
                <div className="text-sm text-gray-500 dark:text-gray-400">{t('hero_stat_branches')}</div>
              </div>
              <div>
                <div className="text-2xl font-bold text-gray-800 dark:text-gray-100">24/7</div>
                <div className="text-sm text-gray-500 dark:text-gray-400">{t('hero_stat_support')}</div>
              </div>
            </div>
          </div>

          <div className="relative w-full max-w-lg h-80 rounded-3xl overflow-hidden shadow-2xl">
            <img src={banner} alt="Banking illustration" className="w-full h-full object-cover" />
          </div>
        ...
        <div className="max-w-7xl mx-auto px-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <div className="bg-gray-50 dark:bg-gray-900 rounded-xl p-6 text-center hover:shadow-md dark:hover:shadow-none dark:hover:bg-gray-800 transition-all">
              ...
              <h3 className="font-semibold text-gray-800 dark:text-gray-100 mb-2">{t('services_savings_title')}</h3>
              <p className="text-sm text-gray-500 dark:text-gray-400">{t('services_savings_desc')}</p>
            </div>
            ...
            <div className="bg-gray-50 dark:bg-gray-900 rounded-xl p-6 text-center hover:shadow-md dark:hover:shadow-none dark:hover:bg-gray-800 transition-all">
              ...
              <h3 className="font-semibold text-gray-800 dark:text-gray-100 mb-2">{t('services_transfers_title')}</h3>
              <p className="text-sm text-gray-500 dark:text-gray-400">{t('services_transfers_desc')}</p>
            </div>
            ...
            <div className="bg-gray-50 dark:bg-gray-900 rounded-xl p-6 text-center hover:shadow-md dark:hover:shadow-none dark:hover:bg-gray-800 transition-all">
              ...
              <h3 className="font-semibold text-gray-800 dark:text-gray-100 mb-2">{t('services_loans_title')}</h3>
              <p className="text-sm text-gray-500 dark:text-gray-400">{t('services_loans_desc')}</p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-10">
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-blue-600 to-blue-800 dark:from-blue-800 dark:to-gray-900 px-10 py-16 flex items-center justify-between flex-wrap gap-10">
            ...
            <div className="relative w-full max-w-sm rounded-2xl overflow-hidden shadow-xl">
              <img src={appImage} alt="Download on Google Play and App Store" className="w-full h-auto object-cover" />
            </div>
      ...
      <section className="py-20 bg-white dark:bg-gray-950 transition-colors">
        <div className="max-w-7xl mx-auto px-10">
          ...
          <div className="text-center max-w-xl mx-auto mb-14">
            ...
            <h2 className="text-3xl font-bold text-gray-800 dark:text-gray-100">{t('testimonials_title')}</h2>
            <p className="text-gray-500 dark:text-gray-400 mt-3">{t('testimonials_subtitle')}</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-50 dark:bg-gray-900 rounded-2xl p-8 hover:shadow-lg dark:hover:bg-gray-800 transition-all">
              ...
              <p className="text-gray-600 dark:text-gray-300 text-sm mb-6 leading-relaxed">
                "Switching to Khmer Bank was the best decision. Transfers are instant and the app just works, every time."
              </p>
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-sm font-semibold text-gray-800 dark:text-gray-100">Sophea K.</div>
                  <div className="text-xs text-gray-400 dark:text-gray-500">Small Business Owner</div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-50 dark:bg-gray-900 rounded-2xl p-8 hover:shadow-lg dark:hover:bg-gray-800 transition-all">
              ...
              <p className="text-gray-600 dark:text-gray-300 text-sm mb-6 leading-relaxed">
                "Opening my savings account took less than 10 minutes on my phone. No branch visit needed at all."
              </p>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-blue-100 dark:bg-blue-900/40 text-blue-600 dark:text-blue-400 flex items-center justify-center font-bold">
                  D
                ...
                <div>
                  <div className="text-sm font-semibold text-gray-800 dark:text-gray-100">Dara P.</div>
                  <div className="text-xs text-gray-400 dark:text-gray-500">University Student</div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-50 dark:bg-gray-900 rounded-2xl p-8 hover:shadow-lg dark:hover:bg-gray-800 transition-all">
              ...
              <p className="text-gray-600 dark:text-gray-300 text-sm mb-6 leading-relaxed">
                "Customer support actually picks up fast and solves problems. That's rare for a bank these days."
              </p>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-blue-100 dark:bg-blue-900/40 text-blue-600 dark:text-blue-400 flex items-center justify-center font-bold">
                  M
                ...
                <div>
                  <div className="text-sm font-semibold text-gray-800 dark:text-gray-100">Makara T.</div>
                  <div className="text-xs text-gray-400 dark:text-gray-500">Freelance Designer</div>
                </div>
              </div>
            </div>
